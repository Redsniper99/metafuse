                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center gap-3 mb-4">
                            <img src="/metafuse.svg" alt="Metafuse" className="w-10 h-10" />
                            <h3 className="text-2xl font-bold bg-gradient-to-r from-[#2f70c5] to-[#4a8de8] bg-clip-text text-transparent">
                                metafuse
                            </h3>
                        </div>
                        <p className="text-foreground/60 mb-4 max-w-sm">
                            Crafting innovative digital solutions with cutting-edge technology and beautiful design.
                        </p>
